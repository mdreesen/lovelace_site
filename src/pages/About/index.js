            ...
            <div className="about-container">
                ...
                <div className="about-text-container">
                    <div className="about-para-container">
                        <h3 className="brianna-name-title">Brianna Lovelace</h3>
                        <p className="about-text-one">I am Brianna Lovelace. My birth work journey started a little over 3 years ago when I was pregnant with my first child. We hired her not fully sure of the decision or understanding her worth in that moment. I went on to birth my son with no pain medicine in the hospital with a midwife.
                    ...
                    <p className="about-text-three">I started an online certification program and found out very quickly that it was not for me at all. I didn’t align with the teachings and the teachings were very superficial. I realized that I didn’t want to just know how to support women. I want to know how to be with women in whatever way I was needed.
                    I continued to self educate myself while working until learned about Indie Birth’s doula training in the fall of 2019. I went through this program and loved every minute of it. We dove deep into heart work, what it meant to be with women, how to hold space and so much more. 
                    This program stated that it purposely did not certify its trainees because women do not need to be certified to know how to be with women. 
                    I realized that resonated so deeply. I am grateful for the lessons that I learned in that training and am proud to be able to have an education, not just a certification.
                    </p>
